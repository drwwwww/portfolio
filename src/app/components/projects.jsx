  ...
  return (
            ...
            >
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm">Airline Flight Delay Predictor (In Progress)</h2>
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm">Mendr</h2>
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm">MeP3</h2>
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm">Data Probe</h2>
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm">Student Grade Database</h2>
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm max-sm:text-sm max-sm:text-sm">Local Explorer</h2>
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm max-sm:text-sm">Movie Lookup</h2>
                ...
                <div className="card-body">
                    ...
                    <h2 className="card-title max-sm:text-sm max-sm:text-sm">Notes App</h2>
